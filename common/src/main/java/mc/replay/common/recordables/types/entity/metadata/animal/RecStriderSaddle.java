...
public record RecStriderSaddle(EntityId entityId, boolean saddle) implements EntityStateRecordable {

    public RecStriderSaddle(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.saddle);
    }
}