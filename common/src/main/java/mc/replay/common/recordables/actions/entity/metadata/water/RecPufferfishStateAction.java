...
public record RecPufferfishStateAction() implements EntityRecordableAction<RecPufferfishState> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecPufferfishState recordable, @UnknownNullability IEntityProvider provider) {
        ...
        if (entityMetadata instanceof PufferfishMetadata pufferfishMetadata) {
            Metadata metadata = pufferfishMetadata.getMetadata();
