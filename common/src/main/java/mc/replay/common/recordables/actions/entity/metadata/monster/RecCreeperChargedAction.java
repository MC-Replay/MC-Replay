...
public record RecCreeperChargedAction() implements EntityRecordableAction<RecCreeperCharged> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecCreeperCharged recordable, @UnknownNullability IEntityProvider provider) {
