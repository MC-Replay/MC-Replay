...
public record RecPandaSneezing(EntityId entityId, boolean sneezing) implements EntityStateRecordable {

    public RecPandaSneezing(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.sneezing);
    }
}