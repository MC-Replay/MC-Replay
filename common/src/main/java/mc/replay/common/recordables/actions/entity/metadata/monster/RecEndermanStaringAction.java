...
public record RecEndermanStaringAction() implements EntityRecordableAction<RecEndermanStaring> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecEndermanStaring recordable, @UnknownNullability IEntityProvider provider) {
