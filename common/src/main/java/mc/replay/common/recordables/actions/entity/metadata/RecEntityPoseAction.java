...
public record RecEntityPoseAction() implements EntityRecordableAction<RecEntityPose> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecEntityPose recordable, @UnknownNullability IEntityProvider provider) {
