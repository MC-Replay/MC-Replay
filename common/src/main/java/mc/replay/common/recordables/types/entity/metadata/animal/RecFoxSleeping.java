...
public record RecFoxSleeping(EntityId entityId, boolean sleeping) implements EntityStateRecordable {

    public RecFoxSleeping(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.sleeping);
    }
}