...
public record RecArmorStandSmall(EntityId entityId, boolean small) implements EntityStateRecordable {

    public RecArmorStandSmall(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.small);
    }
}