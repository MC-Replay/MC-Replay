...
public record RecEntityHelmet(EntityId entityId, ItemWrapper item) implements EntityStateRecordable {

    public RecEntityHelmet(EntityId entityId, ItemStack itemStack) {
        this(entityId, new ItemWrapper(itemStack));
    }

    public RecEntityHelmet(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
