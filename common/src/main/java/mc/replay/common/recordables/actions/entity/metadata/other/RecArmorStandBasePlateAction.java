...
public record RecArmorStandBasePlateAction() implements EntityRecordableAction<RecArmorStandBasePlate> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecArmorStandBasePlate recordable, @UnknownNullability IEntityProvider provider) {
