...
public record RecFoxPouncing(EntityId entityId, boolean pouncing) implements EntityStateRecordable {

    public RecFoxPouncing(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.pouncing);
    }
}