...
public record RecPandaSitting(EntityId entityId, boolean sitting) implements EntityStateRecordable {

    public RecPandaSitting(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
