...
public record RecAbstractHorseEating(EntityId entityId, boolean eating) implements EntityStateRecordable {

    public RecAbstractHorseEating(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.eating);
    }
}