...
public record RecBeeNectar(EntityId entityId, boolean nectar) implements EntityStateRecordable {

    public RecBeeNectar(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.nectar);
    }
}