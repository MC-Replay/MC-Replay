...
public record RecTurtleEgg(EntityId entityId, boolean egg) implements EntityStateRecordable {

    public RecTurtleEgg(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
