...
public record RecAbstractHorseSaddled(EntityId entityId, boolean saddled) implements EntityStateRecordable {

    public RecAbstractHorseSaddled(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.saddled);
    }
}