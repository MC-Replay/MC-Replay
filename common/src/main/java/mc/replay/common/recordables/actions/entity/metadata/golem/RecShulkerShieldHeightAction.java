...
public record RecShulkerShieldHeightAction() implements EntityRecordableAction<RecShulkerShieldHeight> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecShulkerShieldHeight recordable, @UnknownNullability IEntityProvider provider) {
        ...
        if (entityMetadata instanceof ShulkerMetadata shulkerMetadata) {
            Metadata metadata = shulkerMetadata.getMetadata();
