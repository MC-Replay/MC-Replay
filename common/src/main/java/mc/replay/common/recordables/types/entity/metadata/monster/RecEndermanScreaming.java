...
public record RecEndermanScreaming(EntityId entityId, boolean screaming) implements EntityStateRecordable {

    public RecEndermanScreaming(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.screaming);
    }
}