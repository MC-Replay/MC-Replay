...
public record RecMobLeftHandedAction() implements EntityRecordableAction<RecMobLeftHanded> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecMobLeftHanded recordable, @UnknownNullability IEntityProvider provider) {
        ...
        if (entityMetadata instanceof MobMetadata mobMetadata) {
            Metadata metadata = mobMetadata.getMetadata();
