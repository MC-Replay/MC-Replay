...
public record RecEntityInvisible(EntityId entityId, boolean invisible) implements EntityStateRecordable {

    public RecEntityInvisible(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.invisible);
    }
}