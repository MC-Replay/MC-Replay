...
public record RecEntityCorrectPositionAndRotation(EntityId entityId, Pos position, boolean onGround) implements Recordable {

    public RecEntityCorrectPositionAndRotation(EntityId entityId, Location to, boolean onGround) {
        this(
                entityId,
                Pos.from(to),
                onGround
    ...
    public RecEntityCorrectPositionAndRotation(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
