...
public record RecWolfBegging(EntityId entityId, boolean begging) implements EntityStateRecordable {

    public RecWolfBegging(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.begging);
    }
}