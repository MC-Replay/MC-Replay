...
public record RecPandaRolling(EntityId entityId, boolean rolling) implements EntityStateRecordable {

    public RecPandaRolling(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.rolling);
    }
}