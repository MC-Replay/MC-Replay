...
public record RecEntityBoots(EntityId entityId, ItemWrapper item) implements EntityStateRecordable {

    public RecEntityBoots(EntityId entityId, ItemStack itemStack) {
        this(entityId, new ItemWrapper(itemStack));
    }

    public RecEntityBoots(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
