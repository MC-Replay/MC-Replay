...
public record RecFurnaceMinecartFuelAction() implements EntityRecordableAction<RecFurnaceMinecartFuel> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecFurnaceMinecartFuel recordable, @UnknownNullability IEntityProvider provider) {
        ...
        if (entityMetadata instanceof FurnaceMinecartMetadata furnaceMinecartMetadata) {
            Metadata metadata = furnaceMinecartMetadata.getMetadata();
