...
public record RecStriderShaking(EntityId entityId, boolean shaking) implements EntityStateRecordable {

    public RecStriderShaking(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.shaking);
    }
}