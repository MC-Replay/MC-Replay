...
public record RecEndermanCarriedBlockAction() implements EntityRecordableAction<RecEndermanCarriedBlock> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecEndermanCarriedBlock recordable, @UnknownNullability IEntityProvider provider) {
