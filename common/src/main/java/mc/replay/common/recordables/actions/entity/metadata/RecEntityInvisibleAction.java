...
public record RecEntityInvisibleAction() implements EntityRecordableAction<RecEntityInvisible> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecEntityInvisible recordable, @UnknownNullability IEntityProvider provider) {
