...
public record RecPiglinDancing(EntityId entityId, boolean dancing) implements EntityStateRecordable {

    public RecPiglinDancing(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.dancing);
    }
}