...
public record RecTurtleLayingEgg(EntityId entityId, boolean layingEgg) implements EntityStateRecordable {

    public RecTurtleLayingEgg(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.layingEgg);
    }
}