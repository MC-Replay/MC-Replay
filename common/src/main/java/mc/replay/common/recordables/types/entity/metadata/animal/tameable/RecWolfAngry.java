...
public record RecWolfAngry(EntityId entityId, boolean angry) implements EntityStateRecordable {

    public RecWolfAngry(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.angry);
    }
}