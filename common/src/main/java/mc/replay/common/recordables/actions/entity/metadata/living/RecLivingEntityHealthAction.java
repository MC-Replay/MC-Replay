...
public record RecLivingEntityHealthAction() implements EntityRecordableAction<RecLivingEntityHealth> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecLivingEntityHealth recordable, @UnknownNullability IEntityProvider provider) {
