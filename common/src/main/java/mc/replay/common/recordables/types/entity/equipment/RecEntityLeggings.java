...
public record RecEntityLeggings(EntityId entityId, ItemWrapper item) implements EntityStateRecordable {

    public RecEntityLeggings(EntityId entityId, ItemStack itemStack) {
        this(entityId, new ItemWrapper(itemStack));
    }

    public RecEntityLeggings(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
