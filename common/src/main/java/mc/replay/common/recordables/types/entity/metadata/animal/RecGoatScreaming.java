...
public record RecGoatScreaming(EntityId entityId, boolean screaming) implements EntityStateRecordable {

    public RecGoatScreaming(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
