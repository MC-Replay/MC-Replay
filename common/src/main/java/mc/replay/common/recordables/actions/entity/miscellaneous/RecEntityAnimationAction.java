...
public record RecEntityAnimationAction() implements EntityRecordableAction<RecEntityAnimation> {
    ...
    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecEntityAnimation recordable, @NotNull Function<Integer, RecordableEntityData> function) {
