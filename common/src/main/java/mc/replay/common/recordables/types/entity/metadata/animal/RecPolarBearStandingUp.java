...
public record RecPolarBearStandingUp(EntityId entityId, boolean standingUp) implements EntityStateRecordable {

    public RecPolarBearStandingUp(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.standingUp);
    }
}