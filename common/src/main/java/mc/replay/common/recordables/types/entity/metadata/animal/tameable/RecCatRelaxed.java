...
public record RecCatRelaxed(EntityId entityId, boolean relaxed) implements EntityStateRecordable {

    public RecCatRelaxed(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(BOOLEAN)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(BOOLEAN, this.relaxed);
    }
}