...
public record RecPandaHiddenGene(EntityId entityId, int gene) implements EntityStateRecordable {

    public RecPandaHiddenGene(@NotNull ReplayByteBuffer reader) {
        this(
                new EntityId(reader),
                reader.read(VAR_INT)
        );
    ...
    public void write(@NotNull ReplayByteBuffer writer) {
        ...
        writer.write(VAR_INT, this.gene);
    }
}