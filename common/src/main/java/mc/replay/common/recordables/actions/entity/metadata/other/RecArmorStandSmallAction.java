...
public record RecArmorStandSmallAction() implements EntityRecordableAction<RecArmorStandSmall> {

    @Override
    public @NotNull List<@NotNull ClientboundPacket> createPackets(@NotNull RecArmorStandSmall recordable, @UnknownNullability IEntityProvider provider) {
