...
import mc.replay.common.utils.color.patterns.GradientPattern;
import mc.replay.common.utils.color.patterns.Pattern;
import mc.replay.common.utils.color.patterns.RainbowPattern;
import mc.replay.common.utils.color.patterns.SolidPattern;
...
public class RGBColorAPI {
    ...
    public static List<String> process(@NotNull List<String> strings) {
        return strings.stream().map(RGBColorAPI::process).collect(Collectors.toList());
    }
