...
import mc.replay.nms.v1_16_5.recordable.sound.RecNamedSoundEffect;
...
public class NamedSoundEffectPacketOutConverter implements DispatcherPacket<PacketPlayOutNamedSoundEffect> {

    @Override
    public @Nullable List<Recordable> getRecordable(PacketPlayOutNamedSoundEffect packet) {
        try {
            ...
            return List.of(RecNamedSoundEffect.of(namespacedKey, categoryName, x, y, z, volume, pitch));
