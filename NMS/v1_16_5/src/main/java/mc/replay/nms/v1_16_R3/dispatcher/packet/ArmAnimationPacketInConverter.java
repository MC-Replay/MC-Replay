//package mc.replay.nms.v1_16_5.dispatcher.event.packet;
//
...
//
//public record ArmAnimationPacketInConverter() implements DispatcherPacket<RecEntitySwingHandAnimation> {
//
//    @Override
