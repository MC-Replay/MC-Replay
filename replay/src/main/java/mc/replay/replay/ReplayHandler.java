...
import mc.replay.replay.time.ReplayJumpTimeHandler;
...
public final class ReplayHandler implements IReplayHandler {
    ...
    private final ReplayJumpTimeHandler jumpTimeHandler;
    ...
    public ReplayHandler(MCReplayInternal instance) {
        ...
        this.jumpTimeHandler = new ReplayJumpTimeHandler(instance);
