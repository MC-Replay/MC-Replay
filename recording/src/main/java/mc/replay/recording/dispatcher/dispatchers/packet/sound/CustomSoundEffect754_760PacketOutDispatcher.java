...
public final class CustomSoundEffect754_760PacketOutDispatcher extends DispatcherPacketOut<ClientboundCustomSoundEffect_754_758Packet> {
    ...
    @Override
    public List<Recordable> getRecordables(RecordingSession session, ClientboundCustomSoundEffect_754_758Packet packet) {
        return List.of(
