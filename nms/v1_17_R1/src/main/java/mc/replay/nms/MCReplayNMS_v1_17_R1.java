...
import mc.replay.nms.player.PlayerProfile_v1_17_R1;
...
public final class MCReplayNMS_v1_17_R1 implements MCReplayNMS {

    private static final JavaReflections.FieldAccessor<AtomicInteger> ENTITY_ID_COUNTER;

    static {
        ENTITY_ID_COUNTER = JavaReflections.getField(Entity.class, "b", AtomicInteger.class);
    }

    private final DataWatcherReader_v1_17_R1 dataWatcherReader;

    public MCReplayNMS_v1_17_R1() {
        this.dataWatcherReader = new DataWatcherReader_v1_17_R1(this);
    }
    ...
    public RItemStack modifyItemStack(org.bukkit.inventory.ItemStack itemStack) {
        ...
        return new RItemStack_v1_17_R1(itemStack, nmsItemStack);
    }
    ...
    public IRecordingFakePlayer createFakePlayer(FakePlayerHandler fakePlayerHandler, Player target) {
        return new RecordingFakePlayer_v1_17_R1(fakePlayerHandler, target);
    }
