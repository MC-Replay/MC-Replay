...
import mc.replay.nms.NBTConverter_v1_17_R1;
import net.minecraft.world.item.ItemStack;
import org.bukkit.craftbukkit.v1_17_R1.inventory.CraftItemStack;

public final class RItemStack_v1_17_R1 implements RItemStack {
    ...
    public RItemStack_v1_17_R1(org.bukkit.inventory.ItemStack bukkitItemSTack, ItemStack itemStack) {
        ...
        this.compoundTag = NBTConverter_v1_17_R1.convertFromNMS(MC_REPLAY_TAG, rTag);
    }
    ...
    public ItemStack getNMSInstance() {
        ...
        if (!this.compoundTag.isEmpty()) {
            compound.put(MC_REPLAY_TAG, NBTConverter_v1_17_R1.convertToNMS(this.compoundTag));
        }
