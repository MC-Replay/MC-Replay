...
public final class RecordingFakePlayer_v1_21_R1 extends ServerPlayer implements IRecordingFakePlayer {

    private static final AtomicInteger FAKE_PLAYER_COUNT = new AtomicInteger();

    private final FakePlayerHandler fakePlayerHandler;
    private final RecordingFakePlayerNetworkManager_v1_21_R1 fakeNetworkManager;
    private final Player target;
    private boolean recording = false;

    public RecordingFakePlayer_v1_21_R1(FakePlayerHandler fakePlayerHandler, Player target) {
        super(
        ...
        this.fakeNetworkManager = new RecordingFakePlayerNetworkManager_v1_21_R1(this);
        this.connection = new ServerGamePacketListenerImpl(MinecraftServer.getServer(), this.fakeNetworkManager, this, null);
    }
    ...
    public void tick() {
        ...
        if (this.target == null || !this.target.isOnline() || this.target.isDead()) {
            ...
            super.serverLevel().getChunkSource().move(this);
        }
    }
