...
public final class RecordingFakePlayer_v1_20_R1 extends ServerPlayer implements IRecordingFakePlayer {

    private static final AtomicInteger FAKE_PLAYER_COUNT = new AtomicInteger();

    private final FakePlayerHandler fakePlayerHandler;
    private final RecordingFakePlayerNetworkManager_v1_20_R1 fakeNetworkManager;
    private final Player target;
    private boolean recording = false;

    public RecordingFakePlayer_v1_20_R1(FakePlayerHandler fakePlayerHandler, Player target) {
        super(
        ...
        this.fakeNetworkManager = new RecordingFakePlayerNetworkManager_v1_20_R1(this);
