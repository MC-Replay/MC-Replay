...
import mc.replay.nms.NBTConverter_v1_19_R3;
import net.minecraft.world.item.ItemStack;
import org.bukkit.craftbukkit.v1_19_R3.inventory.CraftItemStack;

public final class RItemStack_v1_19_R3 implements RItemStack {
    ...
    public RItemStack_v1_19_R3(org.bukkit.inventory.ItemStack bukkitItemSTack, ItemStack itemStack) {
        ...
        this.compoundTag = NBTConverter_v1_19_R3.convertFromNMS(MC_REPLAY_TAG, rTag);
    }
    ...
    public ItemStack getNMSInstance() {
        ...
        if (!this.compoundTag.isEmpty()) {
            compound.put(MC_REPLAY_TAG, NBTConverter_v1_19_R3.convertToNMS(this.compoundTag));
        }
