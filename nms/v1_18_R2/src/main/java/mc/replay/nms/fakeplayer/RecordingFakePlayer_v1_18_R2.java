...
public final class RecordingFakePlayer_v1_18_R2 extends ServerPlayer implements IRecordingFakePlayer {

    private static final AtomicInteger FAKE_PLAYER_COUNT = new AtomicInteger();

    private final FakePlayerHandler fakePlayerHandler;
    private final RecordingFakePlayerNetworkManager_v1_18_R2 fakeNetworkManager;
    private final Player target;
    private boolean recording = false;

    public RecordingFakePlayer_v1_18_R2(FakePlayerHandler fakePlayerHandler, Player target) {
        super(
        ...
        this.fakeNetworkManager = new RecordingFakePlayerNetworkManager_v1_18_R2(this);
    ...
    public void spawn() {
        ...
        // Start tracker
        super.getLevel().getChunkSource().addEntity(this);
