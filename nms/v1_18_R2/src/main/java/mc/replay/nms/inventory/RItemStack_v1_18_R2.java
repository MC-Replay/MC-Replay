...
import mc.replay.nms.NBTConverter_v1_18_R2;
import net.minecraft.world.item.ItemStack;
import org.bukkit.craftbukkit.v1_18_R2.inventory.CraftItemStack;

public final class RItemStack_v1_18_R2 implements RItemStack {
    ...
    public RItemStack_v1_18_R2(org.bukkit.inventory.ItemStack bukkitItemSTack, ItemStack itemStack) {
        ...
        this.compoundTag = NBTConverter_v1_18_R2.convertFromNMS(MC_REPLAY_TAG, rTag);
    }
    ...
    public ItemStack getNMSInstance() {
        ...
        if (!this.compoundTag.isEmpty()) {
            compound.put(MC_REPLAY_TAG, NBTConverter_v1_18_R2.convertToNMS(this.compoundTag));
        }
