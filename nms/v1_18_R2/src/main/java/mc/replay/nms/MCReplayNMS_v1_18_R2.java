...
public final class MCReplayNMS_v1_18_R2 implements MCReplayNMS {
    ...
    public CompoundTag itemMetaToNBT(org.bukkit.inventory.ItemStack itemStack) {
        ...
        CompoundTag compoundTag = NBTConverter_v1_18_R2.convertFromNMS("", nmsCompoundTag.copy());
    ...
    public ItemMeta itemMetaFromNBT(CompoundTag compoundTag) {
        ...
        net.minecraft.nbt.CompoundTag nmsCompoundTag = NBTConverter_v1_18_R2.convertToNMS(compoundTag);
